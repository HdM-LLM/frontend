...
export default function UploadPage() {
  ...
  return (
    <Container maxWidth="lg" sx={{ mt: 10, mb: 4 }}>
      ...
      {alert ? (
        <Alert severity="error">Oops, something went wrong... Please add files</Alert>
      ) : (
        <></>
      )}
      {success ? <Alert severity="success">🎉 Files send successfully!</Alert> : <></>}
    </Container>
  );
}
